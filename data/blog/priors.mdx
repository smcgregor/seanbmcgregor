...
<figure>
  <a target="_blank" href="/static/images/blog/content/midjourney_prior_belief.png">
    <img style={{ maxWidth: 800 }} width="100%" src="/static/images/blog/content/midjourney_prior_belief.png" />
  </a>
  <figcaption>The result of prompting the Midjourney text-to-image model with the prompt, "prior belief." This is an interesting output because it evokes the notion of carving ones biases from an undifferentiated mass of stone. Simultanously, it provokes us to ask "what is this?" It has human ears, but the face of an animal. What the beholder perceives in the image is subject to the human's pre-existing biases of what constitutes the human and animal forms.</figcaption>
</figure>
...
<i className="fad fa-paw" style={{ fontSize: "x-large" }} />
